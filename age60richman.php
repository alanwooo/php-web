...
<h2>牡丹宝经典案例</h2>
<div class="news-list">
    <div class="zichanxianzhuang"><a href="#">60岁造福社会案例</a> </div><!--保险规划-->
    <div class="anlititle"><strong>让结余更多</strong></div><!--收支结余-->
    <div class="tiaoxingtu"><img src="image/60zaofushehui.jpg" /></div>
    <div class="anlititle-list">牡丹宝建议：您家庭的月结余率健康，请将月结余率维持在50%（10000元）。</br>
健康的收支状况是未来财富增长的基础。为了顺利达成您的理财目标，开源节流、提高结余是关键。但我们不主张以降低生活品质为代价提高结余，所以需要您更聪明地管理收支，取得“达成理财目标”与“保证生活品质”的平衡。</div><!--牡丹宝建议-->
    <div class="nijiating-list"><strong>一、您的月结余率较健康，建议维持在50%（10000元）。</strong></br>
...
此外，收入的年增长率通常需保持在至少5%，10%以上比较理想。大多数人通过以下手段有效地实现了“开源”：</br></div><!--你家庭的月...-->
    ...
    <div class="nidejiating-list"><strong>三、您的月支出（10000元）较高，高于75%的个人。</strong></div><!--你的家庭高于-->
...
<div class="tiaoxingtu2"><img src="image/60zaofushehuixingdongjihua.jpg" /></div>
    <div class="fulu-list"><img src="image/biaoge1.jpg" /></div>
    <div class="touziguihua-list"><strong>投资规划</strong></div>
    <div class="fuerdaitouziguihua"><img src="image/60zaofutouziguihua.jpg"</div><!--投资规划-->
...
您的金融资产总额为2000000元 （为计算方便，四舍五入至百位）。在前面的规划中，我们建议您将其中 200000元（活期存款和货币基金）作为紧急备用金来储备，作单独的规划安排。因此：
