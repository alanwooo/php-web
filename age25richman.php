...
<h2>牡丹宝经典案例</h2>
<div class="news-list">
    <div class="zichanxianzhuang"><a href="#">富二代案例</a> </div><!--保险规划-->
    <div class="anlititle"><strong>让结余更多</strong></div><!--收支结余-->
    <div class="tiaoxingtu"><img src="image/fuerdaishouzhi.jpg" /></div>
    <div class="anlititle-list">牡丹宝建议：您家庭的月结余率健康，请将月结余率维持在37%（3000元）。</br>
健康的收支状况是未来财富增长的基础。为了顺利达成您的理财目标，开源节流、提高结余是关键。但我们不主张以降低生活品质为代价提高结余，所以需要您更聪明地管理收支，取得“达成理财目标”与“保证生活品质”的平衡。</div><!--牡丹宝建议-->
    <div class="nijiating-list"><strong>一、您的月结余率极不健康，建议维持在35%（7,000元）。</strong></br>
当前月结余率=（月收入20000元-月支出20000元）/月收入20000元=0%</br>
您当前的月结余状况极不健康，请改进。挖掘开源节流的潜力，会帮助您更快进行财富积累。</br>
<strong>二、您的税后月收入为20,000元，显著高于当地平均收入 ( 3,332元 )。</strong></br> 
...
此外，收入的年增长率通常需保持在至少5%，10%以上比较理想。大多数人通过以下手段有效地实现了“开源”：</br></div><!--你家庭的月...-->
    ...
    <div class="nidejiating-list"><strong>三、您的月支出（20,000元）过高，高于85%的个人。</strong></div><!--你的家庭高于-->
...
<div class="tiaoxingtu2"><img src="image/fuerdaixingdongjihua.jpg" /></div>
    <div class="fulu-list"><img src="image/biaoge1.jpg" /></div>
    <div class="touziguihua-list"><strong>投资规划</strong></div>
    <div class="fuerdaitouziguihua"><img src="image/fuerdaitouziguihua.jpg"</div><!--投资规划-->
...
您的金融资产总额为550,000元（为计算方便，四舍五入至百位）。在前面的规划中，我们建议您将其中50,000元（活期存款和货币基金）作为紧急备用金来储备，作单独的规划安排。因此：
您当前的可投资资产为550,000元-50,000元=500,000元</br>
...
<div class="xianyouzichan"><img src="image/fuerdaixianyouzichan.jpg" /></div>
...
<div class="zichanxianzhuang-1"><img src="image/fuerdaizichanxianzhuang.jpg" /></div>
<div class="nidejiatingcaifu"><strong>一、您的家庭财富（净资产）= 1550000元</strong></br>
净资产 = 资产总计1550000元 - 负债总计0元 = 1550000元</br>
您已经有了十分可观的财富积累。但这只是一个起点，如果善加投资，财富成长速度会越来越快。</br>
<strong>二、您家庭的资产负债率 = 25%，财务风险较低。</br></strong>
资产负债率 = 负债总计800000元 / 资产总计3200000元 = 25%</br>
您的资产负债率为25%，债务负担较低。请您继续保持健康的收支状况、稳健投资，不断提升抵御财务风险的能力。</br></div>
<div class="xiayigeanli"><a href="age40richman.php">查看下一个案例</a></div>
</div><!--news-list-->
</div><!--list-box结束-->
</div><!--list-main结束-->
