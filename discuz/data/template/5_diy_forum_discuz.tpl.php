...
0
|| checktplrefresh('./template/xinglan_lu05/forum/discuz.htm', './template/xinglan_lu05/common/header.htm', 1417050174, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/xinglan_lu05', 'forum/discuz')
|| checktplrefresh('./template/xinglan_lu05/forum/discuz.htm', './template/xinglan_lu05/common/footer.htm', 1417050174, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/xinglan_lu05', 'forum/discuz')
|| checktplrefresh('./template/xinglan_lu05/forum/discuz.htm', './template/default/common/header_common.htm', 1417050174, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/xinglan_lu05', 'forum/discuz')
|| checktplrefresh('./template/xinglan_lu05/forum/discuz.htm', './template/xinglan_lu05/common/toptb.htm', 1417050174, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/xinglan_lu05', 'forum/discuz')
|| checktplrefresh('./template/xinglan_lu05/forum/discuz.htm', './template/default/common/header_qmenu.htm', 1417050174, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/xinglan_lu05', 'forum/discuz')
|| checktplrefresh('./template/xinglan_lu05/forum/discuz.htm', './template/xinglan_lu05/common/pubsearchform.htm', 1417050174, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/xinglan_lu05', 'forum/discuz')
;?>
...
<ul><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="a" <?php } ?><?php echo $nav['nav'];?>></li>
<?php } } ?>
</ul>
<?php if($_G['setting']['disfixednv_forumindex'] == 0) { ?>
...
<td class="scbar_txt_td"><input type="text" name="srchtxt" id="scbar_txt" value="请输入搜索内容" autocomplete="off" /></td>	<td class="scbar_type_td"><a href="javascript:;" id="scbar_type" class="showmenu xg1" onclick="showMenu(this.id)" hidefocus="true">搜索</a></td>
<td class="scbar_btn_td"><button type="submit" name="searchsubmit" id="scbar_btn" class="pn pnc" value="true"><span style="color:#336699; font-weight:bolder; font-size:14px;">搜索</span></button></td>
...
<?php } ?><div class="bottombg">
<div id="wp" class="wp"><link rel="stylesheet" type="text/css" href="template/xinglan_lu05/common/discuz.css">
...
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><a href="portal.php">&nbsp;��ҳ</a><em>&raquo;</em><a href="forum.php"<?php if($_G['setting']['forumjump']) { ?> id="fjump" onmouseover="delayShow(this, 'showForummenu(<?php echo $_G['fid'];?>)');" class="showmenu" <?php } ?>><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?>
</div>
</div>
<?php if(empty($gid)) { ?>
<div class="wp">
...
<p class="chart z">今日: <em><?php echo $todayposts;?></em><span class="pipe">|</span>昨日: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>帖子: <em><?php echo $posts;?></em><span class="pipe">|</span>会员: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { ?><span class="pipe">|</span>欢迎新会员: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2a"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?></p>
<div class="y">
...
<?php } else { ?>
<em class="l">
<?php if(!$forum['redirect']) { ?><span class="t"><?php echo '����'; ?>:</span><?php } if($forum['redirect']) { ?><a href="<?php echo $forumurl;?>" class="xi2">链接到外部地址</a><?php } elseif(is_array($forum['lastpost'])) { ?><a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost"><?php echo $forum['lastpost']['dateline'];?></a><?php } else { ?>从未<?php } ?>
</em>
<?php } ?>
</dd>
...
<dl<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="margin-left: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
<dt><a href="<?php echo $forumurl;?>" class="xs2"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><em>&nbsp;&nbsp;(<?php echo dnumber($forum['posts']); ?>)</em></dt>


 <p style="font-size:14px; padding-right:15px; color:#999999"><?php if($forum['description']) { ?><?php echo $forum['description'];?><?php } else { ?>
 
 <dd class="xg1" style="font-size:14px;">
<?php if(!$forum['redirect']) { ?><em<?php if($forum['todayposts']) { ?> class="xi1"<?php } ?>><span class="t">今日:</span><?php if($forum['todayposts']) { ?><?php echo $forum['todayposts'];?><?php } else { ?>0<?php } ?></em><?php } if($forum['permission'] == 1) { ?>
私密版块
<?php } else { ?>
<em class="l">
...
<div class="ft_wp">
  <div id="ft" class="wp cl">
    <div class="clear"></div>
   <p style="float:left;margin-top:65px; font-size:14px; color:#666666;">Powered by Discuz! X3.1<br />
*2001-2013 Comsenz Inc.</p>

                <p id="ddbb">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;�������� | ��ϵ���� | �������:��ICP��1100000000��<br />
 Copyright 2013  �������-������̳ ��Ȩ���� All Rights Reserved.</p><?php updatesession();?><?php if($_G['uid'] && $_G['group']['allowinvisible']) { ?>
<script type="text/javascript">
...
<div id="scrolltop">
<ul>
<!--<li><a href="javascript:void(0)" title="��Ϊ��ҳ" onclick="setHomepage(window.location);" class="set_home"><span>��Ϊ��ҳ</span></a></li>-->
<li><a href="javascript:void(0)" title="��Ϊ��ҳ" onclick="setHomepage(window.location);" class="set_home"><span>��Ϊ��ҳ</span></a></li>
<li><a href="portal.php#wd_home7" title="����" class="scroll_news"><span>����</span></a></li>
<li><a href="portal.php#wd_home3" title="����" class="scroll_pic"><span>����</span></a></li>
<li><a href="javascript:void(0)" title="返回顶部" onclick="window.scrollTo('0','0')" class="scroll_top"><span>���ض���</span></a></li>
</ul>
</div>	
<?php } else { ?>
<div id="scrolltop">
