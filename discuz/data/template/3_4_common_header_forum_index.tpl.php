...
0
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/header_common.htm', 1416440251, '4', './data/template/3_4_common_header_forum_index.tpl.php', './template/comiis_lssy', 'common/header_forum_index')
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/header_qmenu.htm', 1416440251, '4', './data/template/3_4_common_header_forum_index.tpl.php', './template/comiis_lssy', 'common/header_forum_index')
|| checktplrefresh('./template/comiis_lssy/common/header.htm', './template/default/common/pubsearchform.htm', 1416440251, '4', './data/template/3_4_common_header_forum_index.tpl.php', './template/comiis_lssy', 'common/header_forum_index')
;?>
