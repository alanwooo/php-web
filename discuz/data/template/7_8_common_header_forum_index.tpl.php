...
0
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_common.htm', 1417044267, '8', './data/template/7_8_common_header_forum_index.tpl.php', './template/wxd_smartisan', 'common/header_forum_index')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_qmenu.htm', 1417044267, '8', './data/template/7_8_common_header_forum_index.tpl.php', './template/wxd_smartisan', 'common/header_forum_index')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/pubsearchform.htm', 1417044267, '8', './data/template/7_8_common_header_forum_index.tpl.php', './template/wxd_smartisan', 'common/header_forum_index')
;?>
