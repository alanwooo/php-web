...
<?php if($_G['setting']['icp']) { ?>( <a href="http://www.miitbeian.gov.cn/" target="_blank" rel="nofollow"><?php echo $_G['setting']['icp'];?></a> )<?php } ?>
...
<div id="frt">
<p>Powered by <strong>Discuz!</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?></p>
<p class="xs0">&copy; 2001-2014 <a href="http://www.Weixiaoduo.com" target="_blank">Weixiaoduo.com</a><a href="http://xiangni.com/">.</a>
</p>
