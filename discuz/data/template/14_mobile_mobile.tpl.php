...
0
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/eyoung_skin_news_001/common/header.htm', 1417050351, 'mobile', './data/template/14_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/footer.htm', 1417050351, 'mobile', './data/template/14_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_common.htm', 1417050351, 'mobile', './data/template/14_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_qmenu.htm', 1417050351, 'mobile', './data/template/14_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/eyoung_skin_news_001/common/pubsearchform.htm', 1417050351, 'mobile', './data/template/14_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/eyoung_skin_news_001/common/eyoung_nav.htm', 1417050351, 'mobile', './data/template/14_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
;?>
...
<?php } ?>
<div id="eyoung_toptb" class="cl">
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_top'])) echo $_G['setting']['pluginhooks']['global_cpnav_top'];?>
<div class="wp">
<div class="z" id="tphone">
<a target="_blank" href="misc.php?mod=mobile">手机版</a><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { if($tpz!=1) { ?><span class="pipe">|</span><?php } ?><?php echo $nav['code'];?><?php } ?> 
<?php } ?>
                    <?php if(empty($_G['disabledwidthauto']) && $_G['setting']['switchwidthauto']) { } ?>
<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra1'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra1'];?>
</div>
<div class="y"><?php include template('common/header_userstatus'); ?>                    <?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra2'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra2'];?><?php if(is_array($_G['setting']['topnavs']['1'])) foreach($_G['setting']['topnavs']['1'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } if(empty($_G['disabledwidthauto']) && $_G['setting']['switchwidthauto']) { if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});"></a><?php } } ?>
</div>
</div>
</div>
...
<?php if(($_G['group']['allowmanagearticle'] || $_G['group']['allowpostarticle'] || $_G['group']['allowdiy'] || getstatus($_G['member']['allowadmincp'], 4) || getstatus($_G['member']['allowadmincp'], 6) || getstatus($_G['member']['allowadmincp'], 2) || getstatus($_G['member']['allowadmincp'], 3))) { ?>
                    <li><a href="javascript:openDiy();" title="打开 DIY 面板" onMouseOver="showMenu(this.id)">DIY</a></li>
                   <?php } ?>
...
<tr>
<td><input type="text" name="srchtxt" id="scbar_txt" value="请输入搜索内容" class="kmssk xg1" autocomplete="off" x-webkit-speech speech /></td>
<td><a href="javascript:;" id="scbar_type" class="showmenu xg1 kmssxlk" onclick="showMenu(this.id)" hidefocus="true">搜索</a></td>
<td><button type="submit" name="searchsubmit" id="scbar_btn" sc="1" class="pn pnc" value="true"><strong class="xi2"></strong></button></td>
</tr>
</table>
</form>
</div>
<ul id="scbar_type_menu" class="p_pop" style="position: absolute; z-index: 301; left: 1035.5px; top: 70px; display: none;"><?php echo implode('', $slist);; ?></ul>
...
<!--二级导航内容开始  -->
<div class="eyoung_nav">
   <dt class="eyoung_icoA">
<li><a href="#" target=_blank>焦点访谈</a></li>
<li><a href="#" target=_blank>中经茶馆</a></li>
<li><a href="#" target=_blank>传媒视点</a></li>
<li><a href="#" target=_blank>经济观察</a></li>
   </dt>
   <dt class="eyoung_icoB">
<li><a href="#" target=_blank>谈股论经</a></li>
<li><a href="#" target=_blank>论坛服务</a></li>
<li><a href="#" target=_blank>温馨港湾</a></li>
<li><a href="#" target=_blank>人物专访</a></li>
   </dt>
   <dt class="eyoung_icoC">
<li><a href="#" target=_blank>指标解释</a></li>
<li><a href="#" target=_blank>质量监督</a></li>
<li><a href="#" target=_blank>行业分析</a></li>
<li><a href="#" target=_blank>行业安全</a></li>
   </dt>
   <dt class="eyoung_icoD">
<li><a href="#" target=_blank>中小企业</a></li>
<li><a href="#" target=_blank>楼市地产</a></li>
<li><a href="#" target=_blank>食品产业</a></li>
<li><a href="#" target=_blank>能源产业</a></li>		
<li><a href="#" target=_blank>通讯产业</a></li>
<li><a href="#" target=_blank>汽车产业</a></li>
   </dt>
</div> 
