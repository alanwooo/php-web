...
0
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_common.htm', 1417042068, '8', './data/template/7_8_common_header_home_spacecp.tpl.php', './template/wxd_smartisan', 'common/header_home_spacecp')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_qmenu.htm', 1417042068, '8', './data/template/7_8_common_header_home_spacecp.tpl.php', './template/wxd_smartisan', 'common/header_home_spacecp')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/pubsearchform.htm', 1417042068, '8', './data/template/7_8_common_header_home_spacecp.tpl.php', './template/wxd_smartisan', 'common/header_home_spacecp')
;?>
