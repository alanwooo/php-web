...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1417042027, '8', './data/template/7_8_member_login.tpl.php', './template/wxd_smartisan', 'member/login')
