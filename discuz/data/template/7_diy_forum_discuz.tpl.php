...
<?php if($_G['uid']) { ?><a href="forum.php?mod=guide&amp;view=my" title="我的帖子" class="xi2">我的帖子</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="forum.php?mod=guide&amp;view=new" title="最新回复" class="xi2">最新回复</a><span class="pipe">|</span><a href="home.php?mod=space&amp;do=favorite&amp;view=me" title="收藏" class="xi2">收藏</a><span class="pipe">|</span><a href="home.php?mod=task" title="任务" class="xi2">任务</a><span class="pipe">|</span><a href="home.php?mod=medal" title="勋章" class="xi2">勋章</a>&nbsp;<?php } ?>
</div>
</div>
<?php } ?>
