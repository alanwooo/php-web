...
0
|| checktplrefresh('./template/travel_linzi/common/header.htm', './template/travel_linzi/common/header_common.htm', 1417049408, '3', './data/template/2_3_common_header_portal_portalcp.tpl.php', './template/travel_linzi', 'common/header_portal_portalcp')
|| checktplrefresh('./template/travel_linzi/common/header.htm', './template/travel_linzi/common/pubsearchform.htm', 1417049408, '3', './data/template/2_3_common_header_portal_portalcp.tpl.php', './template/travel_linzi', 'common/header_portal_portalcp')
;?>
