...
0
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_common.htm', 1416441255, '8', './data/template/7_8_common_header_home_space.tpl.php', './template/wxd_smartisan', 'common/header_home_space')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_qmenu.htm', 1416441255, '8', './data/template/7_8_common_header_home_space.tpl.php', './template/wxd_smartisan', 'common/header_home_space')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/pubsearchform.htm', 1416441255, '8', './data/template/7_8_common_header_home_space.tpl.php', './template/wxd_smartisan', 'common/header_home_space')
;?>
