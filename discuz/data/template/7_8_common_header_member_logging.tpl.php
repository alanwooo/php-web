...
0
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_common.htm', 1417048344, '8', './data/template/7_8_common_header_member_logging.tpl.php', './template/wxd_smartisan', 'common/header_member_logging')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/header_qmenu.htm', 1417048344, '8', './data/template/7_8_common_header_member_logging.tpl.php', './template/wxd_smartisan', 'common/header_member_logging')
|| checktplrefresh('./template/wxd_smartisan/common/header.htm', './template/default/common/pubsearchform.htm', 1417048344, '8', './data/template/7_8_common_header_member_logging.tpl.php', './template/wxd_smartisan', 'common/header_member_logging')
;?>
...
<div class="wp">
<div class="hdc cl"><?php $mnid = getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="./" title="首页"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2><?php include template('common/header_userstatus'); ?></div>
