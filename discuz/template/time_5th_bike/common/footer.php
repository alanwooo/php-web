...
<!--{if empty($topic) || ($topic[usefooter])}-->
  ...
  <div class="wpn pos cl">
    <div class="ft-info z">
      ...
      <div class="ft-title z"><strong></strong>
        <p>时尚设计，国内最时尚的模板设计平台! </p>
        <p>三年来一直为站长做最好的服务而不断努力着! </p>
      </div>
    </div>
    <div class="ft-list y">
      <div class="ft-nav">         
      ...
      <p class="ft-copyright" style="color: #B8C4CC; text-align: right;">
         Copyright &copy; 2014 <a href="http://www.comsenz.com" target="_blank" style="color: #B8C4CC;">Comsenz Inc. </a>
         Powered by <a href="http://www.discuz.net" target="_blank" style="color: #B8C4CC;">Discuz!</a> <em style="color: #B8C4CC;">$_G['setting']['version']. </em>
         <!--{if $_G['setting']['icp']}--> <a href="http://www.miitbeian.gov.cn/" target="_blank" style="color: #B8C4CC;">$_G['setting']['icp']</a> <!--{/if}-->
      </p>
      <div class="ft-shares">
         <a target="_blank" style="margin-top:4px; width:84px;" href="#"><img alt="安全联盟认证" style="border: medium none;" src="template/time_5th_bike/src/hy_83x30.png" width="83" height="30" /></a>
