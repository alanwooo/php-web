		...
		<div class="mn animated fadeInUp">
			<div class="bm bml">
				...
				<div class="bm_h cl">
					...
					<h1>
						<a href="forum.php?mod=forumdisplay&fid=$_G[fid]" style="font-family: 'Microsoft Yahei'; font-size: 16px;">$_G['forum'][name]</a>
			...
			<!--{if !$subforumonly}-->
				...
				<!--{if !($_G['forum']['simple'] & 1) && $_G[setting][whosonlinestatus]}-->
					<div class="bm">
						<!--{if $detailstatus}-->
						<div class="bm_h cl">
							<span class="o y" style="margin: 4px 0 0 0;"><a href="forum.php?mod=forumdisplay&fid=$_G[fid]&page=$page&showoldetails=no#online"><img src="{IMGDIR}/collapsed_no.gif" alt="" /></a></span>
