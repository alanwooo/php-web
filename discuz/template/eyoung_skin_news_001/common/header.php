	...
	<!--{if empty($topic) || $topic['useheader']}-->
		...
		<div id="eyoung_toptb" class="cl">
			...
			<div class="wp">
				...
				<a target="_blank" href="misc.php?mod=mobile">手机版</a>
				...
				<div class="y">
					...
					<!--{/loop}-->
					<!--{if empty($_G['disabledwidthauto']) && $_G['setting']['switchwidthauto']}-->
						<!--{if $_G['uid'] && !empty($_G['style']['extstyle'])}--><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});"></a><!--{/if}-->
					<!--{/if}-->
				</div>
			</div>
		</div>
