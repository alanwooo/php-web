...
<h2>牡丹宝经典案例</h2>
<div class="news-list">
    <div class="zichanxianzhuang"><a href="#">60岁提携子孙</a> </div><!--保险规划-->
    <div class="anlititle"><strong>让结余更多</strong></div><!--收支结余-->
    <div class="tiaoxingtu"><img src="image/60tixiezisun.jpg" /></div>
    <div class="anlititle-list">牡丹宝建议：您家庭的月结余率健康，请将月结余率维持在50%（4000元）。</br>
健康的收支状况是未来财富增长的基础。为了顺利达成您的理财目标，开源节流、提高结余是关键。但我们不主张以降低生活品质为代价提高结余，所以需要您更聪明地管理收支，取得“达成理财目标”与“保证生活品质”的平衡。</div><!--牡丹宝建议-->
    <div class="nijiating-list"><strong>一、您的月结余率较健康，建议维持在50%（4000元）。</strong></br>
<div class="jiakang">您当前的月结余状况较健康，请保持。挖掘开源节流的潜力，会帮助您更快进行财富积累。</div>
<strong>二、您的税后月收入为8000元，显著高于当地平均收入 ( 3,332元 )。</strong></br> 
...
<div class="tiaoxingtu2"><img src="image/60tixiezisunxingdongjihua.jpg" /></div>
    <div class="fulu-list"><img src="image/biaoge1.jpg" /></div>
    <div class="touziguihua-list"><strong>投资规划</strong></div>
    <div class="fuerdaitouziguihua"><img src="image/60touziguihua.jpg"</div><!--投资规划-->
...
您的金融资产总额为850000元 （为计算方便，四舍五入至百位）。在前面的规划中，我们建议您将其中 50000元（活期存款和货币基金）作为紧急备用金来储备，作单独的规划安排。因此：
您当前的可投资资产为850,000元-50000元=800000元</br>
...
<div class="xianyouzichan"><img src="image/60tixiexianyouzichan.jpg" /></div>
...
<div class="zichanxianzhuang-1"><img src="image/60tixiezichanxianzhuang.jpg" /></div>
<div class="nidejiatingcaifu"><strong>一、您的家庭财富（净资产）= 1700000元</strong></br>
净资产 = 资产总计1700000元 - 负债总计0元 = 1700000元</br>
您已经有了十分可观的财富积累。但这只是一个起点，如果善加投资，财富成长速度会越来越快。</br>
<strong>二、您家庭的资产负债率 = 0%，财务风险较低。</br></strong>
资产负债率 = 负债总计0元 / 资产总计1700000元 = 0%</br>
您的资产负债率为0%，没有债务负担。请您继续保持健康的收支状况、稳健投资，不断提升抵御财务风险的能力。</br></div>
<div class="xiayigeanli"><a href="age60richman.php">查看下一个案例</a></div>
</div><!--news-list-->
</div><!--list-box结束-->
</div><!--list-main结束-->
