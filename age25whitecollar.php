...
<h2>牡丹宝经典案例</h2>
<div class="news-list">
    <div class="zichanxianzhuang"><a href="#">王先生案例</a> </div><!--保险规划-->
    <div class="anlititle"><strong>让结余更多</strong></div><!--收支结余-->
    <div class="tiaoxingtu"><img src="image/tiaoxingtu.jpg" /></div>
...
健康的收支状况是未来财富增长的基础。为了顺利达成您的理财目标，开源节流、提高结余是关键。但我们不主张以降低生活品质为代价提高结余，所以需要您更聪明地管理收支，取得“达成理财目标”与“保证生活品质”的平衡。</div><!--牡丹宝建议-->
    <div class="nijiating-list"><strong>一、您家庭的月结余率较不健康，建议维持在37%（3,000元）。</strong></br>
当前月结余率=（月收入8000元-月支出5000元）/月收入8000元=37%</br>
您当前的月结余状况较健康，请保持。挖掘开源节流的潜力，会帮助您更快进行财富积累。</br>
<strong>二、您家庭的税后月收入为8000元。</strong></br> 
...
此外，收入的年增长率通常需保持在至少5%，10%以上比较理想。大多数人通过以下手段有效地实现了“开源”：</br></div><!--你家庭的月...-->
    ...
    <div class="nidejiating-list"><strong>三、您家庭的月支出（5,000元）偏高，高于55%的家庭。</strong></div><!--你的家庭高于-->
...
<div class="tiaoxingtu2"><img src="image/xingdongjihua.jpg" /></div>
    <div class="tiaoxingtu2"><img src="image/xingdongjihua2.jpg" /></div>
    <div class="fulu-list"><img src="image/biaoge1.jpg" /></div>
    <div class="touziguihua-list"><strong>投资规划</strong></div>
    <div class="zichanpeizhi"><img src="image/zichanpeizhi.jpg" /></div>
...
您的金融资产总额为200,000元（为计算方便，四舍五入至百位）。在前面的规划中，我们建议您将其中20,000元（活期存款和货币基金）作为紧急备用金来储备，作单独的规划安排。因此：
您当前的可投资资产为200,000元-20,000元=180,000元</br>
...
<div class="xianyouzichan"><img src="image/xianyouzichan.jpg" /></div>
...
<div class="zichanxianzhuang-1"><img src="image/zichanxianzhuang.jpg" /></div>
<div class="nidejiatingcaifu"><strong>一、您的家庭财富（净资产）= 200000元</strong></br>
净资产 = 资产总计70000元 - 负债总计0元 = 200000元</br>
您已经有了不错的财富积累。但这只是一个起点，如果善加投资，财富成长速度会越来越快。</br>
<strong>二、您家庭的资产负债率 = 0%，财务风险较低。</br></strong>
资产负债率 = 负债总计0元 / 资产总计200000元 = 0%</br>
您的资产负债率为0，没有债务负担。请您继续保持健康的收支状况、稳健投资，不断提升抵御财务风险的能力。</br></div>
<div class="xiayigeanli"><a href="age25richman.php">查看下一个案例</a></div>
</div><!--news-list-->
</div><!--list-box结束-->
</div><!--list-main结束-->
